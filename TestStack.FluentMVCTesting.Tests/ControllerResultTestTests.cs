...
namespace TestStack.FluentMVCTesting.Tests
{
    ...
    class ControllerResultTestShould
    {
        ...
        public void Check_for_redirect_to_action_with_non_specified_controller()
        {
            ...
            Assert.That(exception.Message, Is.EqualTo("Expected redirect to action 'SomeOtherAction' in 'SomeOther' controller, but instead was given redirect to action with default controller."));
        }
        #endregion
