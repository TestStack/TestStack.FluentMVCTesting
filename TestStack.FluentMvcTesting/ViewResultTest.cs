...
namespace TestStack.FluentMVCTesting
{
    public class ViewResultTest
    {
        ...
        public ModelTest<TModel> WithModel<TModel>() where TModel : class
        {
            ...
            if (castedModel == null)
                throw new ViewResultModelAssertionException(string.Format("Expected view model to be of type '{0}', but it is actually of type '{1}'.", 
                    typeof(TModel).Name, 
                    _viewResult.Model.GetType().Name));
