...
namespace TestStack.FluentMVCTesting
{
    public partial class ControllerResultTest<T>
    {
        public ContentResult ShouldReturnContent(string content = null, string contentType = null, Encoding encoding = null)
        {
            ...
            {
                var actual = contentResult.ContentEncoding != null ? contentResult.ContentEncoding.EncodingName : "null";
                throw new ActionResultAssertionException("Expected encoding to be equal to \{encoding.EncodingName}, but instead was \{actual}.");
            }
